...
public class StatusCalculator : ScriptableObject
{
    ...
    private static string formulaBooleanTrueChars = @"^True$";
    private static string formulaBooleanFalseChars = @"^False$";
    ...
    public float Calculate(StatusInfoData infoData)
    {
        ...
        result = Regex.Replace(result, formulaBooleanTrueChars, "1");
        result = Regex.Replace(result, formulaBooleanFalseChars, "0");
